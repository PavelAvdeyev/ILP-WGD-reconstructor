...
def test_run():
    parser = argparse.ArgumentParser(description="ILP solver for the Conserved Genome Median Problem (CGMP)",
    ...
    args.log_file = os.path.join(args.paper_test, "cgmp.log")
    args.gurobi_log_file = os.path.join(args.paper_test, "gurobi_cgmp.log")
...
def main():
    ...
    args.log_file = os.path.join(args.out_dir, "cgmp.log")
    args.gurobi_log_file = os.path.join(args.out_dir, "gurobi_cgmp.log")
    enable_logging(args.log_file, overwrite=False)
